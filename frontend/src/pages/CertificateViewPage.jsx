...
const CertificateViewPage = () => {
    ...
    const fallbackRoute = isAdmin ? '/admin/certifications' : '/certifications';
    ...
    if (error || !cert) {
        return (
            <div className="empty-state fade-up">
                ...
                <button className="btn-primary-custom" onClick={() => navigate(fallbackRoute)} style={{ marginTop: 16 }}>
                    <RiArrowLeftLine /> {isAdmin ? 'Back to All Certifications' : 'Back to My Certifications'}
                </button>
            </div>
        );
    }
        ...
        <div className="fade-up">
            <div className="page-header">
                <div>
                    ...
                    <p className="page-subtitle">{isAdmin ? 'View certificate details' : 'View and manage your certificate'}</p>
                </div>
