...
- Java 21+
- Maven 3.9+
- MySQL running locally (default: `localhost:3306`, database: `certifypro`, auto-created in local dev)
...
|----------|---------|-------------|
| `MYSQL_URL` | `jdbc:mysql://localhost:3306/certifypro?createDatabaseIfNotExist=true...` | MySQL JDBC URL |
